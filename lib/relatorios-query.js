...
export const ORDENS = {
  ...
  // Ordenar por aqui é a forma de achar quem repetiu o teste — que é raro e
  // vale ser visto, já que só a primeira tentativa conta.
  testes: { coluna: 'total_tentativas', rotulo: 'Testes', direcaoInicial: 'desc' },
}

// A lista mostra pessoas, não tentativas: uma linha por candidato, a primeira
// tentativa dele. Contar a tabela crua faria quem repetiu aparecer várias
// vezes e pesar mais na média da base.
export const TABELA_LISTA = 'raven_candidatos'
...
export function construirHref({ busca, ordem, direcao, base = '/relatorios' }) {
